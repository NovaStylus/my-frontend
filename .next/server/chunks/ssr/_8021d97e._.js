...
function BookAppointmentPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!department || !date || !time || parseInt(amount) > 0 && !payment) {
        ...
        if (response.ok) {
            ...
            router.push(`/patientappointments?department=${encodeURIComponent(department)}&date=${encodeURIComponent(date)}&time=${encodeURIComponent(time)}&amount=${encodeURIComponent(amount)}&status=Pending`);
        } else {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            type: "submit",
                            className: "w-full bg-blue-600 text-white font-semibold px-5 py-3 rounded-lg hover:bg-blue-700 transition",
                            children: "Confirm"
                        }, void 0, false, {
                            fileName: "[project]/app/bookappointment/page.tsx",
                            lineNumber: 154,
...
//# sourceMappingURL=_8021d97e._.js.map